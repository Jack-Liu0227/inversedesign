...
class ClassificationService:
    def create_tag(self, *, name: str, color: str, group_name: str, description: str) -> dict[str, Any]:
        return classification_repo.create_tag(
    ...
    def assign_tags(self, *, source_db: str, source_table: str, source_pk: str, tag_names: list[str]) -> dict[str, Any]:
        annotation_id = classification_repo.upsert_annotation(
            source_db=source_db,
        ...
        classification_repo.assign_tags(annotation_id=annotation_id, tag_names=cleaned_tags)
    ...
    def list_tags(self) -> list[dict[str, Any]]:
        return classification_repo.list_tags()

    def list_annotations(self) -> list[dict[str, Any]]:
        return classification_repo.get_annotations()
