...
from src.common.db_paths import MATERIAL_AGENT_SESSION_DB, MATERIAL_AGENT_SHARED_DB_ID
...
material_doc_manager_agent = Agent(
    ...
    db=SqliteDb(db_file=str(MATERIAL_AGENT_SESSION_DB), id=MATERIAL_AGENT_SHARED_DB_ID),
    instructions=[
