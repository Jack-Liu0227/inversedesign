...
MATERIAL_AGENT_SESSION_DB = DB_DIR / "material_agent_sessions.db"
MATERIAL_AGENT_SHARED_DB_ID = "material-agent-shared-db"
MATERIAL_ROUTER_AGENT_DB = MATERIAL_AGENT_SESSION_DB
MATERIAL_RECOMMENDER_AGENT_DB = MATERIAL_AGENT_SESSION_DB
MATERIAL_PREDICTOR_AGENT_DB = MATERIAL_AGENT_SESSION_DB
MATERIAL_REVIEW_AGENT_DB = MATERIAL_AGENT_SESSION_DB
...
PROMPT_LLMRESPONSE_DB = DB_DIR / "prompt_llmresponse.db"
